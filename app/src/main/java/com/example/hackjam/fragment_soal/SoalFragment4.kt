 ...
 * Use the [SoalFragment4.newInstance] factory method to
 * create an instance of this fragment.
 */
class SoalFragment4 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_soal4, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        button1.setOnClickListener(){
            viewModel.updateListAnswer(3,arrayOf(1,0,0))
        ...
        button2.setOnClickListener(){
            viewModel.updateListAnswer(3,arrayOf(0,1,0))
        ...
        button3.setOnClickListener(){
            viewModel.updateListAnswer(3,arrayOf(0,0,1))
        ...
        viewModel.getAnswerAt(3).observe(viewLifecycleOwner) { answer ->
            for (i in 0..2) {
